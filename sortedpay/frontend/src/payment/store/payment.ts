...
const client = new PaymentServiceClient(import.meta.env.VITE_PAYMENTSERVICE_URL!, {}, createAuthenticatedClientOptions());

const adminClient = new PaymentAdminServiceClient(import.meta.env.VITE_PAYMENTSERVICE_URL!, {}, createAuthenticatedClientOptions());
...
export const createStripeSubscriptionCheckoutSession = async (productId: string, success_url: string, cancel_url: string) => {
    try {
