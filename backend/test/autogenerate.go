...
//go:generate protoc --go_opt=module=sortedstartup/load-test/test/proto --go-grpc_opt=module=sortedstartup/load-test/test/proto --go_out=./proto/ --go-grpc_out=./proto/ --proto_path=../../proto experiment.proto

// This generates JS code from .proto files
//go:generate protoc --ts_opt=no_namespace --ts_opt=unary_rpc_promise=true --ts_opt=target=web --ts_out=../../frontend/sorted-test/proto/ --proto_path=../../proto experiment.proto
