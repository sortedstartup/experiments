...
type DAOFactory interface {
	...
	CreateTenantDAO() (TenantDAO, error)
	Close() error
}
...
func (f *SQLiteDAOFactory) CreateTenantDAO() (TenantDAO, error) {
	return NewTenantSqliteDAO(f.config.Database.SQLite.URL)
}
...
func (f *PostgresDAOFactory) CreateTenantDAO() (TenantDAO, error) {
	return NewTenantPostgresDAO(&f.config.Database.Postgres)
}
